    ...
    if (loading && !category) {
        return (
            <div className="min-h-screen" style={{ background: "#F7FAFC" }}>
                <div className="py-12 md:py-14" style={{ background: "linear-gradient(135deg, #0A2540, #005EB8)" }}>
        ...
        <div className="min-h-screen" style={{ background: "#F7FAFC" }}>
            ...
            >
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    <div className="absolute -top-20 right-0 w-72 h-72 rounded-full opacity-10" style={{ background: "radial-gradient(circle, #16C7D9, transparent 70%)" }} />
                </div>

                <div className="relative z-10 max-w-7xl mx-auto px-6">
                    {/* Breadcrumb */}
                    <div className="flex items-center text-xs text-white/50 mb-5 gap-2">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-5">
                        ...
                        >
                            {category?.image ? (
                                ...
                                <CatIcon size={40} style={{ color: "#16C7D9" }} />
                            )}
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-6 md:py-8">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-16">
                        ...
                        <h2 className="text-xl font-bold mb-2" style={{ color: "#0A2540" }}>No Products Found</h2>
                        <p className="text-gray-500 mb-6">This category doesn&apos;t have any products yet.</p>
                        <Link href="/products" className="inline-flex items-center px-6 py-3 rounded-xl text-white font-semibold hover:opacity-90 transition-colors" style={{ background: "#005EB8" }}>
