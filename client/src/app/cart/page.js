...
export default function CartPage() {
    ...
    return (
        <div className="min-h-screen pb-24" style={{ background: "#F7FAFC" }}>
        <div className="container mx-auto px-4 py-8">
            <div className="mb-8">
                <h1 className="text-2xl md:text-3xl font-bold tracking-tight mb-1" style={{ color: "#0A2540" }}>
                    Your Cart
                </h1>
                <div className="w-16 h-1 rounded-full" style={{ background: "linear-gradient(90deg, #005EB8, #16C7D9)" }} />
            </div>
